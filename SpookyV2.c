...
static INLINE SpookyV2_uint64 Rot64(SpookyV2_uint64 x, int k) {
    return (x << k) | (x >> (64 - k));
}
...
static INLINE void ShortMix(SpookyV2_uint64 *h0, SpookyV2_uint64 *h1, SpookyV2_uint64 *h2, SpookyV2_uint64 *h3) {
